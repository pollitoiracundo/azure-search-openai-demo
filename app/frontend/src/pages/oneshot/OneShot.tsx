    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Ask me anything !</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput placeholder="Ask me anything !" disabled={isLoading} onSend={question => makeApiRequest(question)} />
                </div>
            </div>
